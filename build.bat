...
set commonCompilerFlags= -W1 -arch:AVX2 -wd4556 -wd4805 -nologo -Gm- -GR- -EHsc- -O2 -Oi -DPRINTINPUT=0 -DWIN32=1 -DDEBUG=1 -DPOOL_WIN32=1 -FC -Z7 -I %BLibPath%
...
rem win32
cl -MDd %commonCompilerFlags% -Fmcomponent_printer.map W:\component_printer\component_printer.cpp /link %commonLinkerFlags% /PDB:win32_%random%.pdb
